...
const STAGES = [
  ...
  },
  {
    ...
    endStatus: "Pending Quality Control",
    description: "Average time spent in the production phase",
  },
  {
    key: "qualityControl",
    label: "Quality Control Stage",
    startStatus: "Pending Quality Control",
    endStatus: "Pending Photography",
    description: "Average time spent in quality control",
  },
  {
    key: "photography",
    label: "Photography Stage",
    startStatus: "Pending Photography",
    endStatus: "Pending Packaging",
    description: "Average time spent in photography",
  },
  {
    key: "packaging",
